...
public class CashMainFrame extends javax.swing.JFrame {
    ...
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CashMainFrame.class.getName());
    ...
    private void initializeMainFrame() {
        ...
        // Add all Cashier pages as JPanels (use your renamed classes if applicable)
        ...
        contentPanel.add(new CashAccountPanel().getContentPanel(), "Account");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CashMainFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }
