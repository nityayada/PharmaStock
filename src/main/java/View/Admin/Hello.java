...
public class Hello extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setFont(new java.awt.Font("InaiMathi", 0, 13)); // NOI18N
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/resources/Image/search-icon.png"));
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new Hello().setVisible(true));
    }
